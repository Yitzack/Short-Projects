...
class SHA256
{
	public:
		SHA256(){};
		void Hash_func(uint8_t*, uint64_t, uint32_t*) const;
		void Hash_func(char*, uint64_t, uint32_t*) const;
	private:
		uint32_t RightRot(uint32_t, int) const;
		uint32_t Ch(uint32_t, uint32_t, uint32_t) const;
		uint32_t Maj(uint32_t, uint32_t, uint32_t) const;
		uint32_t Sigma0(uint32_t) const;
		uint32_t Sigma1(uint32_t) const;
		uint32_t sigma0(uint32_t) const;
		uint32_t sigma1(uint32_t) const;
		void DataCopy(uint32_t[], uint8_t*) const;
